...
public class SalesByStoreRecord extends TableRecordImpl<SalesByStoreRecord> implements Record3<String, String, BigDecimal>, ISalesByStore {
     ...
     * Create a detached, initialised SalesByStoreRecord
     */
    public SalesByStoreRecord(org.example.db.generated.tables.pojos.SalesByStore value) {
        super(SalesByStore.SALES_BY_STORE);
