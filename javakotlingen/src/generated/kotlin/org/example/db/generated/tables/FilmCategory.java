...
public class FilmCategory extends TableImpl<FilmCategoryRecord> {
     ...
     */
    public final TableField<FilmCategoryRecord, OffsetDateTime> LAST_UPDATE = createField(DSL.name("last_update"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field("now()", SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");
