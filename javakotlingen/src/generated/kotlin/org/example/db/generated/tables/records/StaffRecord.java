...
public class StaffRecord extends UpdatableRecordImpl<StaffRecord> implements Record11<Integer, String, String, Integer, String, Integer, Boolean, String, String, OffsetDateTime, byte[]>, IStaff {
    ...
    @Override
    public Row11<Integer, String, String, Integer, String, Integer, Boolean, String, String, OffsetDateTime, byte[]> fieldsRow() {
        return (Row11) super.fieldsRow();
    }

    @Override
    public Row11<Integer, String, String, Integer, String, Integer, Boolean, String, String, OffsetDateTime, byte[]> valuesRow() {
    ...
    @Override
    public StaffRecord value10(OffsetDateTime value) {
        setLastUpdate(value);
        return this;
    }
    ...
    @Override
    public StaffRecord values(Integer value1, String value2, String value3, Integer value4, String value5, Integer value6, Boolean value7, String value8, String value9, OffsetDateTime value10, byte[] value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public StaffRecord(Integer staffId, String firstName, String lastName, Integer addressId, String email, Integer storeId, Boolean active, String username, String password, OffsetDateTime lastUpdate, byte[] picture) {
        super(Staff.STAFF);
     ...
     * Create a detached, initialised StaffRecord
     */
    public StaffRecord(org.example.db.generated.tables.pojos.Staff value) {
        super(Staff.STAFF);
