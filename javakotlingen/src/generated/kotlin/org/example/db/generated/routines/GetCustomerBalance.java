...
public class GetCustomerBalance extends AbstractRoutine<BigDecimal> {
     ...
     */
    public static final Parameter<OffsetDateTime> P_EFFECTIVE_DATE = Internal.createParameter("p_effective_date", SQLDataType.TIMESTAMPWITHTIMEZONE(6), false, false);
     ...
     */
    public void setPEffectiveDate(OffsetDateTime value) {
     ...
     */
    public void setPEffectiveDate(Field<OffsetDateTime> field) {
