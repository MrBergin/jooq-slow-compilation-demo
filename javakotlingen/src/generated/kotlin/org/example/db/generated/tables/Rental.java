...
public class Rental extends TableImpl<RentalRecord> {
     ...
     */
    public final TableField<RentalRecord, OffsetDateTime> RENTAL_DATE = createField(DSL.name("rental_date"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "");
     ...
     */
    public final TableField<RentalRecord, OffsetDateTime> RETURN_DATE = createField(DSL.name("return_date"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "");
     ...
     */
    public final TableField<RentalRecord, OffsetDateTime> LAST_UPDATE = createField(DSL.name("last_update"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field("now()", SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");
